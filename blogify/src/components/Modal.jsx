...
function Modal({isOpen, onClose}) {
  return (
        ...
        <div className={`fixed inset-0 w-full flex items-center justify-center ${isOpen ? "":"hidden" }`}>
            <div className='modal-container'>
                <div className='bg-indigo-700 text-center p-5 h-96 lg:w-[500px] rounded shadow-md'>
                    ...
                    {/* modal close btn */}
                    <button onClick={onClose} className='bg-gray-300 hover:bg-gray-400 font-semibold py-2 px-8 rounded inline-flex items-center  mt-5'>
                        Close
                    </button>
                </div>
